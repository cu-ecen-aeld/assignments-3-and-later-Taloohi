...
typedef struct
{
    struct sockaddr_storage *pointer_sock_addr_storage;
    socklen_t *pointer_sock_addr_storage_size;
    struct addrinfo *pointer_hints;
    struct addrinfo *pointer_addr_info;
    int *pointer_socket_fd;
    int *pointer_accept_connection_fd;
} socket_context;
...
int cleanup(socket_context *pointer_socket_context);